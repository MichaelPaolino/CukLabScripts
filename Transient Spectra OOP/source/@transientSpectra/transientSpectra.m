...
%
% stageTable = obj.dbStage(__, 'name1','value1',...)
...
%       to update in the database. By default, obj.dbCommitSave() calls the 
%       SQL INSERT statement to add data to the database. Assigning an 
%       array to 'update' flags obj.dbCommit to call the SQL UPDATE 
...
%       values are allowed, which causes obj.dbCommit(...) to INSERT and
%       UPDATE accordingly.
...
% See Also: GENFKSTRUCT, DATABASE, DBCOMMITSAVE
            ...
            % Remove ID column is set to NaN (for display purposes)
